...
model.add(Dense(3,activation='softmax'))   #다중분류 = softmax , outlayer = 3개(y의 클래스의 갯수 , y의 종류의 갯수)
                                           #Ont Hot Encoding : ex) 0 , 1 , 2 -> 1*2 = 2가 되지않게하기위해서 가치를 동등하게만들어줌(좌표형태로)
                                           #(0,0) , (1,1) , (2,2) ... -> 위치에 1을넣음 나머지0
                                           #y=(150,) -> ont hot encoding ->y클래스의갯수만큼 열이늘어남. (150,3) 
